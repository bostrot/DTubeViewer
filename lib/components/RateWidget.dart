  ...
  Widget build(BuildContext context) {
    ...
    if (!hide) {
      switch (tree) {
        ...
        case 2:
          return rateWidget(
            "How about a rating on the " + (Platform.isIOS ? "App" : "Play") + " Store, then?",
            "Not really",
            "Ok, sure!",
          );
          break;
                          ...
                          onPressed: () {
                            switch (tree) {
                              ...
                              case 1:
                                ...
                                launchURL("mailto:feedback@bostrot.pro?subject=DTube Viewer Feedback");
                                break;
                              // second positive
                              case 2:
                                setState(() {
                                ...
                                Platform.isAndroid
                                    ? launchURL("market://details?id=pro.bostrot.dtubeviewer")
                                    : launchURL("itms://itunes.apple.com/us/app/dtube-viewer/id1358140255");
                                break;
                            }
                          },
                          child: new Padding(
